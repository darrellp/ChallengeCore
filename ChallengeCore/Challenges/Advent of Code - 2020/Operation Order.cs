...
namespace ChallengeCore.Challenges
{
    ...
    {
        [Challenge("Advent of Code 2020", "Operation Order (18)", "https://adventofcode.com/2020/day/18")]
        public class OperationOrder : IChallenge
        {
            public void Solve()
            {
                var lines = GetLines();
                ...
                // Part 1
                var sum = lines.Sum(Parser1.Evaluate);

                WriteLine(sum);

                // Part 2
                sum = lines.Sum(Parser2.Evaluate);
            ...
            private class Reader
            {
                ...
                {
                    _f = new string(formula.Where(c => c != ' ').ToArray()) + '$';
                }
            ...
            private class Parser1
            {
                private readonly Reader _reader;
                private readonly long _ret;

                private Parser1(string formula)
                {
                    _reader = new Reader(formula);
                    _ret = E();
                }
            ...
            private class Parser2
            {
                ...
                private Parser2(string formula)
                {
                    _reader = new Reader(formula);
                    _ret = E();
                }
