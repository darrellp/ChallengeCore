...
namespace ChallengeCore.Challenges
{
    ...
    {
        [Challenge("Advent of Code 2020", "Password Philosophy (2)", "https://adventofcode.com/2020/day/2")]
        public class PasswordPhilosophy : IChallenge
        {
            public void Solve()
            {
                var search = Cat(
                ...
                while ((line = ReadLine()) != null)
                {
                    ...
                    var pwd = match.Groups["password"].Value;
                    var count = pwd.Count(f => f == letter);
